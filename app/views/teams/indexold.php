...
<!-- Search -->
<div class="mb-4">
    <input type="text" id="teamSearch" placeholder="Search teams…" class="form-control w-full md:w-80 h-10 border border-b-color rounded-md px-3 text-sm
...
<div class="bg-white dark:bg-dark-card border border-b-color rounded-lg overflow-hidden">
    <table id="teamsTable" class="w-full text-sm">
        ...
        <tbody class="divide-y divide-b-color">
            ...
            <tr>
                <td class="px-4 py-3">
                    <a href="/teams/<?= $team['id'] ?>" class="font-medium text-dark hover:text-primary">
