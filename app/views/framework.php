...
<body>
    ...
    <section class="hero">
        <div class="hero-left">
            ...
            <p class="hero-sub">Etus is a lightweight, expressive PHP framework designed for developers who want full
                control without the weight of a full-stack monolith.</p>
        ...
        <div class="hero-right">
            <div class="code-window">
                ...
                <div class="code-body"><span class="c">// Register routes with middleware</span>
                    <span class="k">return</span> <span class="f">function</span>(<span class="v">Router</span> <span
                        class="v">$router</span>) {

                    <span class="v">$router</span>-><span class="f">get</span>(<span class="s">'/'</span>, [<span
                        class="v">HomeController</span>::<span class="k">class</span>, <span class="s">'index'</span>]);

                    <span class="v">$router</span>-><span class="f">get</span>(<span class="s">'/dashboard'</span>,
                    [<span class="v">DashboardController</span>::<span class="k">class</span>, <span
                        class="s">'index'</span>],
                    [<span class="s">'auth'</span>, <span class="s">'log'</span>]
                    );

                    <span class="v">$router</span>-><span class="f">post</span>(<span class="s">'/login'</span>,
                    [<span class="v">AuthController</span>::<span class="k">class</span>, <span
                        class="s">'store'</span>],
            ...
            <div class="code-window" style="margin-top:1.25rem;">
                ...
                <div class="code-body"><span class="k">class</span> <span class="v">HomeController</span> <span
                        class="k">extends</span> <span class="v">BaseController</span>
                    {
                    <span class="k">protected</span> <span class="f">array</span> <span class="v">$middleware</span> =
                    [<span class="s">'auth'</span>];

                    <span class="k">public function</span> <span class="f">index</span>(): <span
                        class="v">Response</span>
                    {
                    ...
                    <span class="s">'users'</span> => (<span class="k">new</span> <span class="v">User</span>)-><span
                        class="f">all</span>(),
                    ]);
                    }
                    }
    ...
    <section class="features" id="features">
        ...
        <div class="features-grid">
            <div class="feature"><span class="feature-icon">⚡</span>
                ...
                <p class="feature-desc">Blazing fast route resolution powered by nikic/fast-route. Zero overhead routing
                    with full HTTP method support.</p>
            </div>
            <div class="feature"><span class="feature-icon">🔒</span>
                <div class="feature-title">Middleware pipeline</div>
                <p class="feature-desc">Apply middleware globally, per-route, per-controller, or per-method. Built-in
                    Auth, Guest, CSRF, and Request Logger.</p>
            </div>
            <div class="feature"><span class="feature-icon">🗄️</span>
                <div class="feature-title">Multi-driver database</div>
                <p class="feature-desc">SQLite and MySQL out of the box. Fluent query builder, audit fields, and
                    activity logging — all configurable per model.</p>
            </div>
            <div class="feature"><span class="feature-icon">🎨</span>
                <div class="feature-title">PHP template views</div>
                <p class="feature-desc">Plain PHP templates with layout support via a $layout variable. Dot notation
                    resolves to nested directories.</p>
            </div>
            <div class="feature"><span class="feature-icon">🌱</span>
                <div class="feature-title">Environment config</div>
                <p class="feature-desc">vlucas/phpdotenv powers clean .env-based configuration with a typed env() helper
                    for safe value casting.</p>
            </div>
            <div class="feature"><span class="feature-icon">📋</span>
                <div class="feature-title">Activity logging</div>
                <p class="feature-desc">Automatic create/update/delete audit trails with configurable user attribution.
                    Enable or disable per model.</p>
            </div>
            <div class="feature"><span class="feature-icon">🛡️</span>
                <div class="feature-title">CSRF protection</div>
                <p class="feature-desc">Token-based CSRF on all state-changing requests. csrf_field() helper for forms
                    with automatic rotation.</p>
            </div>
            <div class="feature"><span class="feature-icon">📦</span>
                <div class="feature-title">PSR-4 autoloading</div>
                <p class="feature-desc">Clean namespace separation between framework and app code. Composer-managed with
                    files-based helper autoloading.</p>
            </div>
            <div class="feature"><span class="feature-icon">🔍</span>
                <div class="feature-title">Path validation</div>
                <p class="feature-desc">Boot-time path verification catches missing files immediately with clear error
                    messages before a request hits.</p>
            </div>
        </div>
    </section>
                ...
                <div class="layer-list">
                    <div class="layer"><span class="layer-num">01</span>
                        <div>
                            ...
                            <div class="layer-desc">public/index.php defines constants, starts session, loads the
                                autoloader, and boots the kernel.</div>
                        </div>
                    </div>
                    <div class="layer"><span class="layer-num">02</span>
                        <div>
                            <div class="layer-title">Bootstrap</div>
                            <div class="layer-desc">Wires .env, view path, middleware registry, database connection, and
                                routes. Returns a configured Kernel.</div>
                        </div>
                    </div>
                    <div class="layer"><span class="layer-num">03</span>
                        <div>
                            <div class="layer-title">Middleware pipeline</div>
                            <div class="layer-desc">Global → route → controller → method middleware run in order,
                                wrapping the controller call symmetrically.</div>
                        </div>
                    </div>
                    <div class="layer"><span class="layer-num">04</span>
                        <div>
                            <div class="layer-title">Controller → View</div>
                            <div class="layer-desc">Controllers return Response objects. view() renders PHP templates
                                with optional layout wrapping.</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="middleware" id="middleware">
        ...
        <div class="mw-grid">
            <div class="mw-card">
                ...
                <p class="mw-desc">Add aliases to Kernel::$middleware. Runs before routing resolves. Perfect for request
                    logging on all routes.</p>
            </div>
            <div class="mw-card">
                <div class="mw-tag">Level 2 — Route</div>
                <div class="mw-title">Per route</div>
                <p class="mw-desc">Pass middleware as the third argument in web.php. Clean and readable, co-located with
                    the route definition.</p>
            </div>
            <div class="mw-card">
                <div class="mw-tag">Level 3 — Controller</div>
                <div class="mw-title">Whole controller</div>
                <p class="mw-desc">Declare $middleware on your controller class. Applied to every method, overridable
                    with only/except.</p>
            </div>
            <div class="mw-card">
                <div class="mw-tag">Level 4 — Method</div>
                <div class="mw-title">Per method</div>
                <p class="mw-desc">Use $middlewareOnly and $middlewareExcept for surgical, per-action middleware control
                    on individual methods.</p>
            </div>
        </div>
    </section>
    ...
    <section class="quickstart" id="quickstart">
        ...
        <div class="qs-steps">
            ...
            <div class="qs-step">
                ...
                <div class="qs-code">cp .env.example .env<br><br>DB_DRIVER=sqlite<br>DB_DATABASE=database/db.sqlite
                </div>
