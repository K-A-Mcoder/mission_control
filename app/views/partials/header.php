                    ...
                    <?php if (has_role('super_admin')): ?>
                        <li class="nav-item dropdown notification_dropdown flex justify-center relative">
                            <a class="nav-link relative p-[0.8375rem] text-[#464a53] text-lg leading-[1] block duration-500 bell dz-fullscreen" href="javascript:void(0);">
                                <svg id="icon-full" viewBox="0 0 24 24" width="20" height="20" stroke="white" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                ...
                                <div class="header-info2 flex items-center">
                                    ...
                                    <div class="header-info text-white max-sm:hidden">
                                        <h6 class="lg:text-[13px] text-xs mb-1 font-semibold text-white leading-[1]">
                                            <?= isset($_SESSION['user_name']) ? auth_user()['name'] . '(' . auth_role() . ')' : 'Developer'; ?>
                                        </h6>
                                        <p class="text-xs leading-[1] text-[#E1E1E1] mb-1">
                                            <?= isset($_SESSION['user_email']) ? auth_user()['email'] : 'dev@example.com'; ?>
                                        </p>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="card border-0 mb-0">
                                    <div class="card-header relative flex items-center justify-between bg-transparent py-2 sm:px-[1.25rem] px-4 border-b border-[#E6E6E6] dark:border-[#444444]">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <h6 class="text-sm"><?= isset($_SESSION['user_name']) ? $_SESSION['user_name'] : 'Developer Account'; ?></h6>
                                                <span class="text-xs text-body-color"><?= isset($_SESSION['position']) ? $_SESSION['position'] : 'Sys Developer'; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body sm:py-2 border-b border-[#E6E6E6] dark:border-[#444444]">
                                        <a href="profile.php" class="dropdown-item py-[0.6rem] px-[1.25rem] block w-full ai-icon hover:bg-primary-light group">
                                        ...
                                        <a href="my_tasks.php?id=<?= isset($_SESSION['user_id']) ? $_SESSION['user_id'] : '1'; ?>" class="dropdown-item py-[0.6rem] px-[1.25rem] block w-full ai-icon hover:bg-primary-light group">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart inline-block">
                                                <path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path>
                                                <path d="M22 12A10 10 0 0 0 12 2v10z"></path>
                                            </svg>

                                            <span class="ml-2 text-[13px] text-body-color group-hover:text-primary">My Tasks</span>
                                    ...
                                    <div class="card-footer px-0 py-2">
                                        <a href="profile_settings.php" class="dropdown-item py-[0.6rem] px-[1.25rem] text-base block w-full ai-icon">
                                            <svg class="inline-block" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
