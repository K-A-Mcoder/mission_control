...
<li>
    <a href="javascript:void(0);" class="has-arrow ">
        ...
        <span class="nav-text">Teams Module</span>
    </a>
    <ul class="sub-menu">
        <li><a href="/dashboard/teams">Overview</a></li>
...
<li>
    <a class="has-arrow " href="javascript:void(0);">
        ...
        <span class="nav-text">Missions Module</span>
    </a>
    <ul class="sub-menu">
        <li><a href="/dashboard/missions">Overview</a></li>
        <li><a href="/missions">Manage Missions</a></li>
    </ul>
</li>
<!-- Tasks  -->
<li>
    <a class="has-arrow " href="javascript:void(0);">
        ...
        <span class="nav-text">Tasks Module</span>
    </a>
    <ul class="sub-menu">
        <li><a href="/dashboard/tasks">Tasks Overview</a></li>
        <li><a href="/tasks/kanban">Kanban Overview</a></li>
